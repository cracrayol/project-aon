...
<!--
  Derived from date.format-date.template.xsl by Jeni Tennison.
  http://exslt.org/date/functions/format-date/date.format-date.template.xsl
  See also http://exslt.org/date/functions/format-date/index.html.

  Change log

  2010-23-11  Ingo Kloecker
    * Commented out import of str.padding.template.xsl since xsltproc supports
      str:padding out-of-the-box.
    * Fixed a bug in date:_format-date with the handling of quoted text in the
      pattern string.
    * Renamed template date:format-date to date:format-date-localized.
...
<date:months lang="es">
   <date:month length="31" abbr="ene.">enero</date:month>
   <date:month length="28" abbr="feb.">febrero</date:month>
   <date:month length="31" abbr="mar.">marzo</date:month>
   <date:month length="30" abbr="abr.">abril</date:month>
   <date:month length="31" abbr="may.">mayo</date:month>
   <date:month length="30" abbr="jun.">junio</date:month>
   <date:month length="31" abbr="jul.">julio</date:month>
   <date:month length="31" abbr="ago.">agosto</date:month>
   <date:month length="30" abbr="sep.">septiembre</date:month>
   <date:month length="31" abbr="oct.">octubre</date:month>
   <date:month length="30" abbr="nov.">noviembre</date:month>
   <date:month length="31" abbr="dic.">diciembre</date:month>
</date:months>
...
<date:days lang="es">
   <date:day abbr="D">domingo</date:day>
   <date:day abbr="L">lunes</date:day>
   <date:day abbr="M">martes</date:day>
   <date:day abbr="X">miércoles</date:day>
   <date:day abbr="J">jueves</date:day>
   <date:day abbr="V">viernes</date:day>
   <date:day abbr="S">sábado</date:day>
</date:days>

<xsl:template name="date:format-date-localized">
         ...
         <xsl:choose>
            ...
            <xsl:when test="$char = 'M'">
               <xsl:choose>
                  ...
                  <xsl:when test="$pattern-length >= 3">
                     <xsl:variable name="month-node" select="document('')/*/date:months[@lang=$language]/date:month[number($month)]" />
                     <xsl:choose>
            ...
            <xsl:when test="$char = 'E'">
               <xsl:choose>
                  ...
                  <xsl:otherwise>
                     <xsl:variable name="month-days" select="sum(document('')/*/date:months[@lang=$language]/date:month[position() &lt; $month]/@length)" />
                     ...
                     <xsl:variable name="dow"
                                   select="(($y-1 + floor($y-1 div 4) -
                                             ...
                                             $days) 
                                            mod 7) + 1" />
                     <xsl:variable name="day-node" select="document('')/*/date:days[@lang=$language]/date:day[number($dow)]" />
                     <xsl:choose>
                        <xsl:when test="$pattern-length >= 4">
